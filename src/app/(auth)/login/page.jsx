    ...
    return (
        <div className="flex items-center justify-center min-h-screen">
            <div className="w-full max-w-sm p-8 bg-white shadow-lg rounded-lg border border-gray-300">
                <h1 className="text-2xl font-bold text-center text-sky-700 mb-6">Login</h1>
                ...
                <div className="space-y-4">
                    <div>
                        ...
                        />
                        {inputErrors.email && (
                            <p className="mt-1 text-red-500 text-sm">{inputErrors.email}</p>
                        )}
                    </div>
                    <div className="relative">
                        ...
                        {inputErrors.password && (
                            <p className="mt-1 text-red-500 text-sm">{inputErrors.password}</p>
                        )}
                ...
                <Button
                    onClick={handleLogin}
                    className="w-full mt-6 py-2 text-lg font-semibold text-white bg-sky-600 rounded-md hover:bg-sky-500 active:bg-sky-700 transition duration-200"
                >
                ...
                <Button onClick={handleGoogleLogin} className="w-full flex items-center justify-center gap-2 py-2 text-lg font-semibold text-gray-700 bg-gray-100 rounded-md hover:bg-gray-200 transition duration-200">
